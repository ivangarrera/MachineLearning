...
data_set = pd.read_csv(r'C:\Users\ivangarrera\Desktop\T2.csv',
                       sep=',')
...
data_set_mean = data_set[[column for column in data_set if \
                          "MagneticField" in column and column.endswith("MEAN")]]

data_set_mean.to_csv(r'C:\Users\ivangarrera\Desktop\T2_cleaned.csv',
                sep=',', index=False)
